...
class TestFieldSelector:
    ...
    def test_get_fields_custom_fields(self):
        ...
        fields = self.selector.get_fields(
            "issues", 
            "minimal",
    ...
    def test_get_fields_exclude_fields(self):
        ...
        fields = self.selector.get_fields(
            "issues",
            "standard", 
            exclude_fields=["description", "priority(name,id)"]
        )
...
class TestFieldSelection:
    ...
    def test_custom_fields_addition(self):
        ...
        custom_fields = selector.get_fields(
            "issues", 
            "minimal",
            custom_fields="priority(name),tags(name)"
        )
    ...
    def test_field_exclusion(self):
        ...
        excluded_fields = selector.get_fields(
            "issues",
            "full", 
            exclude_fields=["description", "attachments(name,size,url)"]
        )
